    <div class="my-3 shadow-lg">
                ...
                <div
                    ...
                    <script>
                        ...
                        const targetDate = new Date("August 25, 2025 20:23:50").getTime();
                    ...
                    <section class="slider2_right col-span-3 relative bg-cover bg-center rounded-lg shadow-lg">
                            ...
                            <div class="flex flex-col md:flex-row gap-6 mb-6">
                                ...
                                <div class="md:w-1/2">
                                    ...
                                    <div
                                        ...
                                        <span class="line-through text-gray-400">۵۸۰٬۰۰۰ تومان</span>
                                        <span class="text-green-600 font-bold">۴۲۰٬۰۰۰ تومان</span>
                                    </div>
                                ...
                                <div class="md:w-1/2 flex flex-col items-center justify-center m-auto">
                                    <p class="text-center font-bold text-lg mb-4">بخار پز فلر</p>
                                    <img style="max-width: 150px !important;" src="public/images/slider2_item1.jpg"
                                        alt="بخار پز فلر" class=" object-contain rounded-lg " />
                                    <button type="button"
                                        class="bg-green-600 my-4 cursor-pointer duration-200 flex focus:outline-none focus:ring-4 gap-2 hover:bg-red-400 hover:px-8 items-center mb-2 me-2 px-5 py-2.5 rounded-lg  text-center text-sm text-white transition-all shadow-md">
                        ...
                        <article
                            ...
                            <div class="flex flex-col md:flex-row gap-6 mb-6">
                                ...
                                <div class="md:w-1/2 flex flex-col items-center justify-center m-auto">
                                    <p class="text-center font-bold text-lg mb-4">بخار پز فلر</p>
                                    <img style="max-width: 150px !important;" src="public/images/slider2_2.jpg"
                                        alt="بخار پز فلر" class=" object-contain rounded-lg " />
                        ...
                        <article
                            ...
                            <div class="flex flex-col md:flex-row gap-6 mb-6">
                                ...
                                <div class="md:w-1/2 flex flex-col items-center justify-center m-auto">
                                    <p class="text-center font-bold text-lg mb-4">بخار پز فلر</p>
                                    <img style="max-width: 150px !important;" src="public/images/slider2_3.jpg"
                                        alt="بخار پز فلر" class=" object-contain rounded-lg " />
                    ...
                    <nav id="sliderNavigator" class="slider2_left col-span-1" aria-label="ناوبری اسلایدر">
                        ...
                        <ul class=" border-r border-gray-200">
                            <li class="border-b border-gray-200 hover:bg-white cursor-pointer" role="button"
                                ...
                                <span class="block py-2.5 text-center">لپ تاپ</span>
                            </li>
                            <li class="border-b border-gray-300 hover:bg-white cursor-pointer" role="button"
                                tabindex="0" data-slide="1">
                                <span class="block py-2.5 text-center">خمیردندان</span>
                            </li>
                            <li class="border-b border-gray-300 hover:bg-white cursor-pointer" role="button"
                                tabindex="0" data-slide="2">
                                <span class="block py-2.5 text-center">مسواک</span>
                            </li>
                            <li class="border-b border-gray-300 hover:bg-white cursor-pointer" role="button"
                                tabindex="0" data-slide="3">
                                <span class="block py-2.5 text-center">کیف</span>
                            </li>
                            <li class="border-b border-gray-300 hover:bg-white cursor-pointer" role="button"
                                tabindex="0" data-slide="4">
                                <span class="block py-2.5 text-center">یخچال</span>
                            </li>
                            <li class="border-b border-gray-300 hover:bg-white cursor-pointer" role="button"
                                tabindex="0" data-slide="5">
                                <span class="block py-2.5 text-center">برنج</span>
                            </li>
                            <li class="border-b border-gray-300 hover:bg-white cursor-pointer" role="button"
                                tabindex="0" data-slide="6">
                                <span class="block py-2.5 text-center">درب ضد سرقت</span>
                            </li>
                            <li class="border-b border-gray-300 hover:bg-white cursor-pointer" role="button"
                                tabindex="0" data-slide="7">
                                <span class="block py-2.5 text-center">دستگیره در</span>
                            </li>
                        </ul>
                    </nav>
