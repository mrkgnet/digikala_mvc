  <div>
        <div class=" bg-white p-4 border border-gray-200  shadow-sm">
            ...
            <div id="productIntro"
                ...
                <p>
                    این محصول یکی از پرفروش‌ترین‌های بازار است که با کیفیت بالا و طراحی مدرن، توانسته رضایت مشتریان
                    زیادی را جلب کند.
                    طراحی زیبا، بدنه مقاوم، عملکرد قوی و ویژگی‌های پیشرفته از جمله خصوصیات برجسته این محصول به شمار
                    می‌آید.
                    همچنین دارای گارانتی معتبر و خدمات پس از فروش گسترده می‌باشد.
                    مناسب برای استفاده روزمره، کاری و حتی حرفه‌ای است.
                    طراحی زیبا، بدنه مقاوم، عملکرد قوی و ویژگی‌های پیشرفته از جمله خصوصیات برجسته این محصول به شمار
                    می‌آید.
                    همچنین دارای گارانتی معتبر و خدمات پس از فروش گسترده می‌باشد.
                    مناسب برای استفاده روزمره، کاری و حتی حرفه‌ای است.
                    ...
                    می‌آید.
                    همچنین دارای گارانتی معتبر و خدمات پس از فروش گسترده می‌باشد.
                    مناسب برای استفاده روزمره، کاری و حتی حرفه‌ای است. طراحی زیبا، بدنه مقاوم، عملکرد قوی و
                    ویژگی‌های پیشرفته از جمله خصوصیات برجسته این محصول به شمار
                    می‌آید.
                    همچنین دارای گارانتی معتبر و خدمات پس از فروش گسترده می‌باشد.
                    مناسب برای استفاده روزمره، کاری و حتی حرفه‌ای است.
                    طراحی زیبا، بدنه مقاوم، عملکرد قوی و ویژگی‌های پیشرفته از جمله خصوصیات برجسته این محصول به شمار
